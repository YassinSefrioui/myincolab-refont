// ============================================================
// INCO LAB — Données de démarrage (issues de SampleData.js de la
// DA, étendues avec les entités du site existant : rôles, projets,
// dossiers, événements, groupes, annonces, audit, codes invités…)
// ============================================================
...
const SEED = {
  ...
  projects: [
    {
      id: 'launch', name: 'Product Launch Q3', archived: false,
    ...
    {
      id: 'site', name: 'Marketing Site Redesign', archived: false,
  ...
  channels: [
    ...
    { id: 'product',     name: 'product',     unread: 3 },
  ...
  messagesByConv: {
    general: [
      { id: 1, user: 'ava', text: 'Bienvenue sur INCO LAB 👋 épinglez ici tout ce qui est important.', time: '8:15' },
    ],
    product: [
      { id: 1, user: 'ava',    text: 'Morning team — pushed the updated pricing doc, take a look before standup', time: '9:02' },
      ...
      { id: 4, user: 'marcus', text: 'Confirmed — mockups for that screen are in the Product Launch board', time: '9:11', thread: 4 },
      { id: 5, user: 'priya',  text: 'Billing API supports the discount code param now, staging is live', time: '9:40', file: { name: 'billing-api-notes.pdf', size: '214 KB' } },
    ...
    engineering: [
      { id: 1, user: 'tomas', text: 'Staging env is back up after the migration', time: '11:20' },
    ],
    random: [
      { id: 1, user: 'jules', text: 'La machine à café du 3e est réparée !', time: 'Lundi' },
    ],
    'dm-ava': [
  ...
  files: [
    { id: 1, name: 'pricing-tiers-v3.pdf',             size: '1,2 Mo', from: 'ava',    where: '#product',          time: 'Il y a 2 h',   folder: 'specs',  version: 3 },
    { id: 2, name: 'onboarding-flow.fig',              size: '8,4 Mo', from: 'marcus', where: 'Product Launch Q3', time: 'Hier',         folder: 'design', version: 1 },
    { id: 3, name: 'billing-api-notes.pdf',            size: '214 Ko', from: 'priya',  where: '#product',          time: 'Hier',         folder: 'specs',  version: 1 },
  ...
  // Les dates sont relatives à aujourd'hui : offset en jours.
  events: [
