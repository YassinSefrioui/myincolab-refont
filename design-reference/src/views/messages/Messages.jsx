...
import { convLabel, member, nextId, nowTime, QUICK_REACTIONS } from '../../lib/helpers.js';
...
export default function Messages() {
  const { db, updateDB, user, prefs, ui, toast, t } = useApp();
  ...
  useEffect(() => { setSummary(null); setOpenThreads(new Set()); }, [convId]);
    ...
    <div className="chat-view view-anim">
      ...
      <div className="chat-scroll" id="chat-scroll" ref={scrollRef}>
        {msgs.map((m, i) => {
          ...
          return (
            <div className={`msg-row${continued ? ' continued' : ''}`} key={m.id}>
                        ...
                        return (
                          <div className="msg" key={r.id}>
                            ...
                            <div style={{ minWidth: 0 }}>
                              <div className="msg-head">
                                <span className="msg-name">{ru.name}</span>
