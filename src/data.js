...
// Date ISO (AAAA-MM-JJ) à n jours d'aujourd'hui — la démo reste vivante.
const dIn = n => {
  const d = new Date();
...
// Timestamp (epoch ms) à n heures d'aujourd'hui — pour trier les fichiers par date/heure réelle.
const hAgo = n => Date.now() - n * 3600000;
...
export const SEED = {
  ...
  team: [
    { id: 'ava',    name: 'Ava Chen',    role: 'MANAGER',  departmentId: 'dept-product',     initials: 'AC', color: '#f0a04b', email: 'ava@incolab.com',    presence: 'online', hiddenProjectsOnProfile: [] },
    { id: 'marcus', name: 'Marcus Webb', role: 'EMPLOYEE', departmentId: 'dept-design',      initials: 'MW', color: '#5b8def', email: 'marcus@incolab.com', presence: 'away', hiddenProjectsOnProfile: [] },
    { id: 'priya',  name: 'Priya Nair',  role: 'EMPLOYEE', departmentId: 'dept-engineering', initials: 'PN', color: '#9b7bf0', email: 'priya@incolab.com',  presence: 'online', hiddenProjectsOnProfile: [] },
    { id: 'tomas',  name: 'Tomas Rein',  role: 'EMPLOYEE', departmentId: 'dept-engineering', initials: 'TR', color: '#4bb37a', email: 'tomas@incolab.com',  presence: 'busy', hiddenProjectsOnProfile: [] },
    { id: 'jules',  name: 'Jules Kim',   role: 'EMPLOYEE', departmentId: 'dept-marketing',   initials: 'JK', color: '#e0607a', email: 'jules@incolab.com',  presence: 'offline', hiddenProjectsOnProfile: [] },
    { id: 'you',    name: 'Sam Ortiz',   role: 'ADMIN',    departmentId: null,               initials: 'SO', color: '#2a9d8f', email: 'sam@incolab.com',    presence: 'online', locked: false, hiddenProjectsOnProfile: [] },
  ],
  ...
  projects: [
    {
      ...
      columns: [
        ...
        { id: 'progress', title: 'In Progress', cards: [
          { id: 3, title: 'Onboarding flow redesign', assignee: 'marcus', label: 'Design', due: dIn(1), priority: 'HIGH',
          ...
          { id: 4, title: 'Billing API integration', assignee: 'priya', label: 'Engineering', due: dIn(2), priority: 'URGENT',
          ...
          { id: 5, title: 'Set up staging environment', assignee: 'tomas', label: 'Engineering', due: dIn(-1), priority: 'HIGH',
            comments: [ { user: 'priya', text: 'Merci !', time: '11:21' } ], subtasks: [], deps: [], done: false },
        ]},
        { id: 'review', title: 'Review', cards: [
          { id: 6, title: 'Checkout flow QA pass', assignee: 'tomas', label: 'QA', due: dIn(0), priority: 'URGENT',
    ...
    },
    {
      ...
      columns: [
        { id: 'backlog', title: 'Backlog', cards: [
          ...
          { id: 102, title: 'Plan de contenu blog', assignee: 'jules', label: 'Marketing', due: dIn(6), priority: 'LOW', comments: [], subtasks: [], deps: [], done: false },
        ]},
        { id: 'progress', title: 'In Progress', cards: [
          { id: 103, title: 'Hero section responsive', assignee: 'marcus', label: 'Design', due: dIn(2), priority: 'HIGH', comments: [], subtasks: [], deps: [], done: false },
        ]},
        { id: 'review', title: 'Review', cards: [
  ...
  files: [
    { id: 1, name: 'pricing-tiers-v3.pdf',             size: '1,2 Mo', from: 'ava',    where: 'Product Launch Q3', time: 'Il y a 2 h',   folder: 'specs',  version: 3, ts: hAgo(2) },
    { id: 2, name: 'onboarding-flow.fig',              size: '8,4 Mo', from: 'marcus', where: 'Product Launch Q3', time: 'Hier',         folder: 'design', version: 1, ts: hAgo(26) },
    { id: 3, name: 'billing-api-notes.pdf',            size: '214 Ko', from: 'priya',  where: 'Product Launch Q3', time: 'Hier',         folder: 'specs',  version: 1, ts: hAgo(30) },
    { id: 4, name: 'launch-announcement-draft.docx',   size: '48 Ko',  from: 'jules',  where: 'Product Launch Q3', time: 'Il y a 2 j',   folder: 'root',   version: 2, ts: hAgo(50) },
    { id: 5, name: 'checkout-qa-checklist.xlsx',       size: '32 Ko',  from: 'tomas',  where: 'Product Launch Q3', time: 'Il y a 3 j',   folder: 'root',   version: 1, ts: hAgo(74) },
  ],
